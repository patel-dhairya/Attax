...
{-|
Emit JSON that describes how the game went
-}
...
data GameReport st mv = GameReport
  ...
  , grP1Name :: String -- ^ Name of player 1's AI
  , grP2Name :: String -- ^ Name of player 2's AI
...
jsonUI config = do
  ...
  let
    ...
    moveSourceName :: MoveSource st mv-> String
